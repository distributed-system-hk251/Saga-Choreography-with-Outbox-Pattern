...
- When running Order Service inside the same Docker Compose network:
  ...
  - MySQL JDBC URL (container/local): jdbc:mysql://database:3306/orderdb (compose maps host port 3306)
- If running the service locally (outside Docker), set env:
  - KAFKA_BOOTSTRAP_SERVERS=localhost:9092
  - SPRING_DATASOURCE_URL=jdbc:mysql://database:3306/orderdb?useSSL=false&serverTimezone=UTC
